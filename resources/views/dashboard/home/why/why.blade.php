...
<div class="container home">
    ...
    <div class="content">
        <div class="left">
            ...
            <a href="/dashboard/home/why" class="active">Why Choose Us</a>
        ...
        <div class="right">
            <a href="/dashboard/home/why/create" class="btn btn-primary">
                Create Reason
            </a>
                    ...
                    <tbody>
                        @foreach ($whys as $why)
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/home/why/edit/{{ $why->id }}">
                                    ...
                                    <a href="/dashboard/home/why/delete/{{ $why->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                            fill="none">
                                            <path
