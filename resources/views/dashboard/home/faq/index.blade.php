...
<div class="container home">
    ...
    <div class="content">
        ...
        <div class="right">
            <a href="/dashboard/home/faq/create" class="btn btn-primary">
                Create FAQ
            </a>
                    ...
                    <tbody>
                        @foreach ($faqs as $faq)
                            <tr>
                                ...
                                <td>
                                    <span class="badge {{ $faq->featured_home ? 'badge-success' : 'badge-secondary' }}">
                                        {{ $faq->featured_home ? 'Yes' : 'No' }}
                                    </span>
                                </td>
                                <td>
                                    <a href="/dashboard/home/faq/edit/{{ $faq->id }}">
                                    ...
                                    <a href="/dashboard/home/faq/delete/{{ $faq->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                            fill="none">
                                            <path
