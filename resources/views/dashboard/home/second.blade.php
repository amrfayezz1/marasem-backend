...
<div class="container home">
    ...
    <div class="content">
        <div class="left">
            ...
            <a href="/dashboard/home/second" class="active">Second Divider Section</a>
        </div>
        <div class="right">
            <form action="{{ route('home.updateSecondDivider') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-floating">
                    <textarea class="form-control" name="title" placeholder="Enter Title" id="title">{{ $homePageSection->second_divider_title ?? '' }}</textarea>
                    <label for="title">Title</label>
                </div>
                <div class="form-floating">
                    <textarea class="form-control" name="second" placeholder="Enter Description" id="second">{{ $homePageSection->second_divider_desc ?? '' }}</textarea>
                ...
                <div class="form-group">
                    ...
                    @if($homePageSection->second_divider_photo)
                        <img src="{{ asset('storage/' . $homePageSection->second_divider_photo) }}" width="200" height="200"
                            alt="Second Divider Background">
                    @endif
                </div>
