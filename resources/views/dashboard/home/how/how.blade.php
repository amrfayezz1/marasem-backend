...
<div class="container home">
    ...
    <div class="content">
        <div class="left">
            ...
            <a href="/dashboard/home/how" class="active">How It Works</a>
        ...
        <div class="right">
            <a href="/dashboard/home/how/create" class="btn btn-primary">
                Create Step
            </a>
                    ...
                    <tbody>
                        @foreach ($hows as $how)
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/home/how/edit/{{ $how->id }}">
                                    ...
                                    <a href="/dashboard/home/how/delete/{{ $how->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                            fill="none">
                                            <path
